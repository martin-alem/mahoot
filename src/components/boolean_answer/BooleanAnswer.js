  ...
  return (
    <div className="BooleanAnswer">
      <div className="BooleanAnswer-opt">
        ...
        <span className="material-icons BooleanAnswer-radio">radio_button_checked</span>
      </div>
      <div className="BooleanAnswer-opt">
        ...
        <span className="material-icons BooleanAnswer-radio">radio_button_unchecked</span>
      </div>
    </div>
  );
}
